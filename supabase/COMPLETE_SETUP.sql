-- ============================================================================
-- SUPABASE COMPLETE SETUP - All-in-One Script
-- ============================================================================
-- Run this in Supabase Dashboard → SQL Editor
-- This will reset the database and create all tables with seed data
-- ⚠️ WARNING: This will delete all existing data!
-- ============================================================================

-- Step 1: Clean slate - Drop and recreate public schema
DROP SCHEMA IF EXISTS public CASCADE;
CREATE SCHEMA public;
GRANT ALL ON SCHEMA public TO postgres;
GRANT ALL ON SCHEMA public TO public;

-- Step 2: Run all migrations (combined from 20251223110000_initial_schema.sql)
...
VALUES (
  ...
  '00000000-0000-0000-0000-000000000001',
  '00000000-0000-0000-0000-000000000011',
  'tro_demo_test_key_12345678901234567890',
  'tro_demo_test_k',
  encode(digest('tro_demo_test_key_12345678901234567890', 'sha256'), 'hex'),
  'Demo Test Key',
  'test',
  'demo',
  100,
...
VALUES (
  ...
  '00000000-0000-0000-0000-000000000001',
  '00000000-0000-0000-0000-000000000011',
  'tro_app_aurora_watcher_v1_production_key_2024',
  'tro_app_aurora_w',
  encode(digest('tro_app_aurora_watcher_v1_production_key_2024', 'sha256'), 'hex'),
  'iOS App Production',
